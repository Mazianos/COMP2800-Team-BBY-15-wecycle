...
export default function DonorPost() {
    ...
    fetch(`/get-own-post/${currentUser.uid}`)
      ...
      .then((result) => {
        ...
        if (Object.keys(result).length === 0) {
          setMsg("No Past Donations Found");
        } else {
          setMsg("Your Past Donations");
        }
      })
      .catch((err) => {
  ...
  return (
    <div className={classes.background}>
      <AboutUsHeading />
      <Typography align="center" id="message">
        {msg}
      </Typography>
        ...
        {yourDonation.map((dono) => (
          <Container>
            ...
            <div className={classes.topHeading}>
              ...
              <div className={classes.postingDate}></div>{" "}
              {/* where posting date woud go into*/}
              <p>Status: {dono.status}</p>
              <div className={classes.status}></div>{" "}
              {/*where status would go into*/}
            </div>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    color="primary"
                    id="plastic"
                    defaultChecked={dono.type.plastic}
                    inputRef={plasticRef}
                  />
                }
                label="Plastic"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    color="primary"
                    id="glass"
                    defaultChecked={dono.type.glass}
                    inputRef={glassRef}
                  />
                }
                label="Glass"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    color="primary"
                    id="aluminum"
                    defaultChecked={dono.type.aluminum}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    color="primary"
                    id="other"
                    defaultChecked={dono.type.other}
                    inputRef={otherRef}
                  />
                }
                label="Other"
